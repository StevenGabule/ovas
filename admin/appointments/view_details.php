                        ...
                        <div class="row">
                                    ...
                                    <fieldset>
                                        ...
                                        <table class="table table-stripped table-bordered" data-placeholder='true'>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Total Service(s)</th>
                                                    <td class="py-1 px-2 text-right"><span style="font-weight: bold;">₱ <?= number_format($totalFee, 2) ?></span></td>
                                                </tr>
                                                
                                                <tr class="border">
                                                    <th class="py-1 px-2 text-light" style="color: black !important">
                                                    <label for="cash" class="control-label">Cash</label>
                                                    </th>
                                                    <td class="py-1 px-2 text-right">
                                                        <div class="form-group">
                                                            <input type="text" name="cash"  style="font-weight: bold;" id="cash" class="form-control form-control-border" placeholder="Enter cash" value="<?= $cash ?>">
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="border">
                                                    ...
                                                    <td class="py-1 px-2 text-right">
                                                        <div class="form-group">
                                                            <input type="text" style="font-weight: bold;" name="change" id="change" class="form-control form-control-border" placeholder="Change" value="<?= $userChange ?>" readonly>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="border">
                                                    ...
                                                    <td class="py-1 px-2 text-right">
                                                        <button type="button" disabled onclick="submit_payment()"  class="btn btn-primary btn-block" id="submit">SUBMIT</button>
                                                    </td>
                                                </tr>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <small class="text-muted px-2 font-weight-bold">Appointment Status</small><br>
                                    <?php 
									switch ($status){
										case 0:
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <small class="text-muted px-2 font-weight-bold">Payment Status</small><br>
                                    <?php 
									switch ($payment_status){
										case 0:
											echo '<span class="ml-4 rounded-pill badge badge-danger">Unpaid</span>';
											break;
										case 1:
											echo '<span class="ml-4 rounded-pill badge badge-success">Paid</span>';
											break;
										default:
											echo '<span class="ml-4 rounded-pill badge badge-danger">Unknown</span>';
									}
								?>
                                </div>
                            </div>
...
<script>
    ...
    function submit_payment($id){
        ...
        var $id = '<?= $_REQUEST['id'] ?>';
		$.ajax({
			url:_base_url_+"classes/Master.php?f=submit_payment",
			method:"POST",
			data:{
                id: $id,
                cash: $cash,
